...
from agent.utils import create_memory_if_not_exists, delete_memory, create_log_dir, log_reward_calculation
...
class ObsidianAgentEnv(MultiTurnEnv):
    ...
    def __init__(
            ...
            base_memory_path: str = MEMORY_PATH,
            **kwargs: Any
        ):
        ...
        self.memory_path = self.base_memory_path
        self.rollout_id = None
        self.log_dir = create_log_dir()
        
        # Set the memory path for this environment
        self.set_rollout_id(uuid.uuid4().hex[:8])
    ...
    def set_rollout_id(self, rollout_id: str) -> None:
        """
        Set the rollout ID and update the memory path.
        ...
        if hasattr(self, 'rubric'):
            self.rubric.set_memory_path(self.memory_path)

    def _clear_memory_dir(self):
        """Clears the contents of the memory directory."""
    ...
    def env_response(self, messages: List[Dict[str, str]], **kwargs: Any) -> Dict[str, str]:
        ...
        try:
            ...
            # If no python code, prompt to take action or provide a final answer.
